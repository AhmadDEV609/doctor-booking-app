...
const AdminDoctors = () => {
    ...
    const handleStatusChange = async (
        ...
        try {
            ...
            const data = await updateDoctorStatus(
                userId,
                status
            );
                                        ...
                                        <div className="flex flex-col sm:flex-row sm:items-start gap-5">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                ...
                                                <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
                                                    ...
                                                    <div
                                                        className={`inline - self - start items - center gap - 1.5 px - 3 py - 1.5 rounded - full border text - xs font - semibold capitalize ${statusStyle.wrapper} `}
                                                    >
