    ...
    return (
        ...
        >
            <select
                ...
                className={`rounded-xl border px-3 py-2.5 text-xs font-bold outline-none transition focus:ring-2 focus:ring-emerald-500/10 disabled:cursor-not-allowed disabled:opacity-60 ${fullWidth
                        ? "w-full"
                        : "min-w-32"
                    } ${statusConfig[
                        appointment?.status
